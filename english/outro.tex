...
{\small define, list, repeat, reproduce, describe, identify, recognize}
...
{\small conclude, test, assess, criticize, justify, argue, check}
...
\item Mindmap/cloud -- \note{gathering associations and relationships}
