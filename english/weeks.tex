...
What is the goal of the lesson? Why am I teaching this?
\vspace*{1cm}
...
\marginsection{-90}{1}{notes and comments}
\vspace*{-2em}
%TODO scoring rubric -> evaluation rubric?
\note{What knowledge, skills, and abilities do I want to teach in my lessons? Express them in the form of a scoring rubric, that is, describe the individual aspects and the scale (see page \pageref{rubric}).\\
...
%TODO lesson aim(s) and lesson objectives
%This needs editing throughout the entire text.  
%"Aims" =  general statements concerning the overall goals, ends or intentions of teaching.
%"Objectives" =  the individual stages that learners must achieve on the way in order to reach these goals.
What is the goal of the lesson? Why am I teaching this?\\
\note{The list of verbs on page \pageref{bloom} may help you articulate your goals.}
\vspace*{1cm}

How do I know I've reached my goal?\\
\note{Is there way to verify that you've reached your goal?}
...
\marginsection{-90}{1}{notes and comments}
\vspace*{-2em}
\note{Have I achieved the goal of this lesson?\\
