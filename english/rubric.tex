...
\newpage
%TODO Tracking appears redundant  
\rubriccriterion{Lesson aims and objectives, conscious attention, tracking}
...
\rule{\textwidth}{0.4pt}
%TODO The three statements below seem illogical/not coherent enough to me - the first focuses on the absence of reflection (in general), the second on the negative feelings the teacher may experience while teaching and the third on the positive feelings during teaching. I would say that being aware of certain emotions and reflecting on them are two different things.
...
%TODO This sounds rather vague (the Czech version does too...) The teacher may not give any feedback  or may not consider the option of giving feedback. 
...
{When I give instructions or assign a task, students understand what to do. They do not work on useless things that do not match my aim.} %TODO This should be correspond with the previous (beginner) statement: ....students understand what to do, where to start or..... should be. 

\newpage
\rubriccriterion{Lesson design and variety}
%TODO In my view, this needs a different descriptor. If the teacher received excellent teacher training and copies the best teachers he/she experienced he/she may be fully aware and may deliver excellent lessons (not only in terms of variety). 
...
%TODO This sounds very vague/imprecise. The focus below is on the lesson aims and objectives (as is in No. 1) and the progress the students make. It might be useful to focus on the three important features of lesson aims/objectives - if they are clear, achievable and measurable. This section might then become No. 2. 
...
%TODO I do not introduce any particular classroom policy. 
...
%TODO particular procedures and strategies
...
\newpage
%TODO Flexibility on the spot
\rubriccriterion{Improvisation, lesson adjustments}
