...
Pomáhá zřetelně si uvědomit a pojmenovat, jaké části daná věc má (např. umět programovat znamená být schopen navrhnout algoritmus, efektivně pracovat s pamětí, znát syntaxi, ...) a taky na jaké úrovni jsem já v jednotlivých částech (např. navrhnout algoritmus umím dobře, zapsat to kódem mám trochu problém a práci s pamětí neoptimalizuju vůbec).
