...
Z jakých bloků se má hodina skládá?\\
...
\marginsection{-90}{1}{volné poznámky}
\vspace*{-2em}
\note{Jaké chtěné/nechtěné precedenty se objevili na hodině?\\
...
Jaké otázky na hodině položím studentům?
\vspace*{0.8cm}
...
Na které otázky studenti reagovali? Na které ne?
...
\marginsection{-90}{1}{volné poznámky}
\vspace*{-2em}
\note{Jaké znalosti a dovednosti chci naučit? (Popiš je do rubriky!)\\
...
Jak poznám, že se cíle podařilo dosáhnout? \\
\note{Stanov si cíle a pak veď výuku tak, abys je naplnil(a).}
...
\vspace{-0.5em}
\note{Připomenutí nástrojů z hodin Praktika vedení cvičení}

\section*{Výuka jako celek}

\begin{itemize}
\item Hospitace -- \note{Jak to dělají jiní? Jak to dělám já?}
\item Precedenty -- \note{očekávané chování studentů/učitele}
...
\begin{itemize}
\item Situování -- \note{pravidelné připomenutí kde jsme a kam jdeme}
\item Označení přechodů -- \note{expliciní přechod do dalšího bloku}
