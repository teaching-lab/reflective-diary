...
\bigskip
We appreciate suggestions for diary improvement or any related comments. Please email Martin at \textit{mukrop@mail.muni.cz.}

Both source files and printable PDFs are available online at \url{github.com/mukrop/reflektivni-denik-ucitele}.

\bigskip
\begin{minipage}{0.68\textwidth}
This diary was authored by Martin Ukrop, Ondráš Přibyla, Valdemar Švábenský and Martin Macák for the course \textit{Teaching Lab} at the Faculty of Informatics, Masaryk University.
\end{minipage}
