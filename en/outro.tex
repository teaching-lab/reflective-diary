...
\begin{itemize}
\item Names and addressing -- \note{first names, nameplates, attendance sheet}
...
\item Tracking -- \note{perceiving (paying attention to) the flow of discussion/lecture}
...
\begin{itemize}
\item Questions for the group -- \note{\enquote{who} + precise quantifiable condition + action}
\item Multiple choice questions -- \note{plausibility of choices}
\item Voting -- \note{positive, negative, points distribution, Kahoot}
\item Assignments -- \note{first step, end-product/deliverable, evaluation, duration}
...
\item Mind map/cloud -- \note{gathering associations, relationships, facilitating discussion}
...
\item Think-pair-share -- \note{think for yourself, discuss in pairs, harvest in group}
